...
## Performance Data
MPOG has received operative case data from last month about Alice and Bob's cases and that of their peers. MPOG calculates the following performance information for the measure SUS-04:
